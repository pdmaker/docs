...
<Note>
**💰 超值价格**  
按次计费，每张图片仅需 $0.01，与 GPT-Image-1 价格相同，但使用更灵活的对话接口！
</Note>
...
<Tip>
💡 **价格对比**  
- GPT-Image-1: $0.01/张（官方 Images API）
- Sora Image: $0.01/张（对话补全 API）
- 价格相同，接口更灵活！
</Tip>
...
def calculate_cost(num_images):
    ...
    # 与 GPT-Image-1 对比
    gpt_image_1_cost = num_images * 0.01  # GPT-Image-1 价格
    
    print(f"Sora Image 成本计算:")
    print(f"- 图片数量: {num_images}")
    print(f"- 单价: ${cost_per_image}")
    print(f"- 总成本: ${total_cost:.2f}")
    print(f"\n对比 GPT-Image-1:")
    print(f"- GPT-Image-1 成本: ${gpt_image_1_cost:.2f}")
    print(f"- 价格相同: 都是 $0.01/张")
    print(f"- 优势: Sora 使用对话接口，更灵活")
...
### Q: 图片质量如何？
A: 基于 Sora 官网同源技术，质量优秀，适合大部分商用场景。与 GPT-Image-1 相比，使用对话接口更加灵活。
